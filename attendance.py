...
class attendance_details():
    def __init__(self,root):
        ...
        #title
        my_label = Label(main_frame, text="Attendance Details", 
                            font=("Quicksand",36,"bold"), bg='#EEF9FF', fg="#05A6F0")
        ...
        #student information
        student_info_frame=LabelFrame(left_frame, 
                                        bd=2, width=832, height=343, relief=RIDGE, 
                                        text="Student Information", font=("times new roman",16,"bold", "italic"), 
                                        bg='white')
        ...
        #1. Enrollment Number
        enr_num_label=Label(student_info_frame, 
                            text="Enrollment Number",font=("times new roman",16),
                            bg='white', fg="red")
        enr_num_label.place(x=18, y=31)
        
        enr_num_label = Entry(student_info_frame, 
        ...
        #2. Name
        name_label=Label(student_info_frame, 
                            text="Name",font=("times new roman",16),
                            bg='white', fg="red")
        name_label.place(x=438, y=31)
        
        name_label = Entry(student_info_frame, 
        ...
        #3. Date
        date_label=Label(student_info_frame, 
                            text="Date",font=("times new roman",16),
                            bg='white', fg="red")
        date_label.place(x=18, y=92)
        
        date_label = Entry(student_info_frame, 
        ...
        #4. Time
        time_label=Label(student_info_frame, 
                            text="Time",font=("times new roman",16),
                            bg='white', fg="red")
        time_label.place(x=438, y=92)
        
        time_label = Entry(student_info_frame, 
        ...
        #5. Status
        status_label=Label(student_info_frame, 
                            text="Status",font=("times new roman",16),
                            bg='white', fg="red")
        status_label.place(x=18, y=153)
        
        status_label = Entry(student_info_frame, 
                                textvariable=self.status, 
                                font=("times new roman",16), 
                                width=15)
        status_label.place(x=201, y=153, width=180, height=30)

        button_frame=LabelFrame(student_info_frame,
        ...
        #Import button
        import_button=Button(button_frame, 
                                command=self.import_csv, 
                                text="Import CSV", font=("times new roman",16,"bold"),
                                bg='#F35325', fg="white")
        ...
        Export_button=Button(button_frame, 
                                ...
                                text="Export CSV", font=("times new roman",16,"bold"),
                                bg='#FFBA08', fg="white")
        ...
        self.details_table=ttk.Treeview(table_frame,
                                        column=("Enrollment number", "Name", "Date", "Time", "Status"), 
    ...
    def export_csv(self):
        try:
            ...
            with open(file_name,mode="w",newline="") as my_file:
                ...
                messagebox.showinfo("Export", "Your data exported to "+os.path.basename(file_name)+" successfully", 
                                        parent=self.root)
